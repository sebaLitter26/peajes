...
var ComandosService = /** @class */ (function () {
    ...
    ComandosService.prototype.obtener_viaje = function (callback) {
        ...
        var url = __WEBPACK_IMPORTED_MODULE_2__config_url_servicios__["p" /* URL_VIAJE */] + '/' + this._us.id_usuario + '/' + this._us.clave;
        return this.http.post(url, data)
            .subscribe(function (resp) {
            console.log(resp);
            //{status: "OK", msg: "Se aceptó solicitud de registro. Se envía SMS al teléfono especificado."}
    ...
    ComandosService.prototype.obtener_parada = function (callback) {
        ...
        //data.append("usuario", this.id_usuario );
        //data.append("clave", this.clave );
        var url = __WEBPACK_IMPORTED_MODULE_2__config_url_servicios__["m" /* URL_PARADA */] + '/' + this._us.id_usuario + '/' + this._us.clave;
        return this.http.post(url, data)
            .subscribe(function (resp) {
            console.log(resp);
            //{status: "OK", msg: "Se aceptó solicitud de registro. Se envía SMS al teléfono especificado."}
...
var MensajePage = /** @class */ (function () {
    ...
    MensajePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-mensaje',template:/*ion-inline-start:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/mensaje/mensaje.html"*/'<ion-header>\n\n  <ion-navbar color="morado">\n    <ion-title>Mensaje Recibido</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <h1>{{ msj.titulo }}</h1>\n\n  <p>\n      {{ msj.contenido }}\n  </p>\n\n  <button ion-button\n          block\n          color="primary"\n          (click)="manda_evento(2)">\n    Cancelar\n  </button>\n\n  <button ion-button\n          block\n          color="danger"\n          (click)="manda_evento(4)">\n    Negativo\n  </button>\n\n\n\n\n</ion-content>\n'/*ion-inline-end:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/mensaje/mensaje.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_index_services__ = __webpack_require__(76);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angularfire2_database__ = __webpack_require__(667);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__config_firebase_config__ = __webpack_require__(688);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__ionic_native_keyboard__ = __webpack_require__(689);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_ionic_audio__ = __webpack_require__(690);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__ionic_native_camera__ = __webpack_require__(692);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_native_in_app_browser__ = __webpack_require__(452);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__angular_platform_browser__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_index_services__ = __webpack_require__(76);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__agm_core__ = __webpack_require__(693);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_index_services__ = __webpack_require__(76);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/app/app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_index_services__ = __webpack_require__(76);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MapaPage = /** @class */ (function () {
    ...
    MapaPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'mapa-page',template:/*ion-inline-start:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/mapa2/mapa.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Mapa2\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="addBoton()"><ion-icon name="add"></ion-icon>agregar Boton</button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div id="map"></div>\n</ion-content>\n'/*ion-inline-end:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/mapa2/mapa.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
...
var PorMensajePage = /** @class */ (function () {
    ...
    PorMensajePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-por-mensaje',template:/*ion-inline-start:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/por-mensaje/por-mensaje.html"*/'\n<ion-header>\n\n  <ion-navbar>\n\n\n\n    <ion-title>{{ this.mensaje.titulo }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-list>\n\n    <ion-item >\n\n      <item-start>{{ this.mensaje.titulo}}</item-start>\n      <ion-note    style="white-space: pre-line;"  >\n         {{this.mensaje.contenido}}\n      </ion-note>\n\n    </ion-item>\n\n    <button ion-button (click)="reproducir_mensaje()" color="{{ speaking ? \'danger\' : \'primary\' }}">\n       {{ speaking ? \'Callar Voz\' : \'Leer Mensaje\' }} \n    </button>\n\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/por-mensaje/por-mensaje.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */],
...
var BrowserPage = /** @class */ (function () {
    ...
    BrowserPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-browser',template:/*ion-inline-start:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/browser/browser.html"*/'<ion-header>\n\n  <ion-navbar color="morado">\n    <ion-title>Internet</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n  <ion-content padding>\n\n    <ion-item>\n      <ion-label floating>URL</ion-label>\n      <ion-input type="url" [(ngModel)]="url"></ion-input>\n    </ion-item>\n\n    <button ion-button block clear (click)="openWebpage(url)">Open Webpage</button>\n\n\n\n</ion-content>\n'/*ion-inline-end:"/home/seba/Desktop/proyectos-personales/fiestas-eventos-2/app/src/pages/browser/browser.html"*/
        }),
...
var URL_SERVICIOS = "http://desa.avelo.com.ar/ws/";
